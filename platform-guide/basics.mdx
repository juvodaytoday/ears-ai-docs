---
title: "EARS AI Basics"
description: "Learn the basics of EARS AI: call types, campaigns, leads, and assistant configuration."
---
...
- EARS AI cost per minute: Charge for using the autocall service
