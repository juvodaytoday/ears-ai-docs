---
title: "Basics"
description: "Core concepts for building with EARS AI."
---
...
A no-code platform for setting up and managing AI calls.
...
- EARS AI cost per minute: Charge for using the AI call service
