...
When calling is enabled on the sender, the conversation header shows **Ask to call** or **Call**. The transcript also records when you asked, when the customer allowed or declined, and when a call happened.

You cannot ask a contact who has not messaged you in the last 24 hours. See [WhatsApp Calling](/whatsapp/calling).
