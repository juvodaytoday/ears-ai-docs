...
icon: "whatsapp"
description: "Connect your AI assistants to WhatsApp Business for automated messages and voice calls"
---
...
- **Answer WhatsApp voice calls** and call customers after they grant permission
...
<CardGroup cols={2}>
  ...
  <Card title="WhatsApp Calling" icon="phone" href="/whatsapp/calling">
    Answer inbound WhatsApp calls and call customers after they grant permission
  </Card>
...
- WhatsApp voice calls (inbound anytime; outbound after the customer allows)
...
- Turn on [WhatsApp Calling](/whatsapp/calling)
