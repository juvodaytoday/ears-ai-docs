...
<Frame caption="ElevenLabs Voice Library — copy the voice link or ID from the ⋮ menu">
  <img src="/resources/ai-assistants/voice-import-elevenlabs.png" alt="Copy voice link in the ElevenLabs Voice Library" />
</Frame>

<Frame caption="Cartesia Voice Library — copy the voice ID from the ⋮ menu">
  <img src="/resources/ai-assistants/voice-import-cartesia.png" alt="Copy ID in the Cartesia Voice Library" />
</Frame>
