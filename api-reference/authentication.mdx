...
The EARS AI API uses API keys to authenticate requests. You need to include your API key in the header of each request you make to the API.

## Obtaining an API Key

To obtain an API key:

1. Log in to your EARS AI account at [https://ai.earsconnect.com](https://ai.earsconnect.com)
...
```bash
curl -X GET "https://ai.earsconnect.com/api/user/campaigns" \
