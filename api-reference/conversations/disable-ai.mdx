...
```bash cURL
curl -X POST "https://ai.earsconnect.com/api/automate/conversations/7c9e6679-7425-40de-944b-e07fc1f90ae7/disable-ai" \
...
const response = await fetch(
  `https://ai.earsconnect.com/api/automate/conversations/${conversationId}/disable-ai`,
  {
    method: 'POST',
    headers: {
...
response = requests.post(
    f'https://ai.earsconnect.com/api/automate/conversations/{conversation_id}/disable-ai',
