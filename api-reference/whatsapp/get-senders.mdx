...
<ResponseField name="data" type="array">
  <Expandable title="Sender object properties">
    ...
    <ResponseField name="voice_calling_enabled" type="boolean">
...
```bash cURL
curl -X GET "https://ai.earsconnect.com/api/user/whatsapp/senders" \
  -H "Authorization: Bearer YOUR_API_KEY"
```

```bash Filter all senders
curl -X GET "https://ai.earsconnect.com/api/user/whatsapp/senders?status=all" \
  -H "Authorization: Bearer YOUR_API_KEY"
```

```javascript JavaScript
const response = await fetch(
  'https://ai.earsconnect.com/api/user/whatsapp/senders',
  {
    headers: {
